...
A recent code refactoring effort was conducted to develop a 100% Python equivalent variant of the 25+ year old Mathcad 3-DOF kinematic ideal proportional navigation guidance missile model. The resulting Python model **propNav** is available for download from publicly accessible GitHub repository [github.com/gedeschaines/propNav](https://github.com/gedeschaines/propNav).
